...
import com.example.a17422_final_project.helpers.GraphicOverlay.Graphic
...
class PoseGraphic internal constructor(
    ...
    private fun maybeUpdatePaintColor(paint: Paint, canvas: Canvas?, zInImagePixel: Float) {
        ...
        if (zInImagePixel < 0) {
            ...
            var v = (zInImagePixel / zLowerBoundInScreenPixel * 255).toInt()
            ...
            var v = (zInImagePixel / zUpperBoundInScreenPixel * 255).toInt()
            v = MathUtils.clamp(v, 0, 255)
